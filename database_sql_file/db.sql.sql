...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2024 at 11:12 AM
...
--
-- Table structure for table `travel_entries`
--
...
ALTER TABLE `likes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `entry_id` (`entry_id`,`user_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- Indexes for table `travel_entries`
--
...
--
-- AUTO_INCREMENT for table `travel_entries`
--
ALTER TABLE `travel_entries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`entry_id`) REFERENCES `travel_entries` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `entry_tags`
  ADD CONSTRAINT `entry_tags_ibfk_1` FOREIGN KEY (`entry_id`) REFERENCES `travel_entries` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `likes`
  ADD CONSTRAINT `likes_ibfk_1` FOREIGN KEY (`entry_id`) REFERENCES `travel_entries` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `photos`
  ADD CONSTRAINT `photos_ibfk_1` FOREIGN KEY (`entry_id`) REFERENCES `travel_entries` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `travel_entries`
--
ALTER TABLE `travel_entries`
  ADD CONSTRAINT `travel_entries_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
